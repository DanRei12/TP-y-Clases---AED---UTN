...
#LIBERÍA UTILIZADA PARA LA GENERACIÓN DEL NÚMERO DE LOS DADOS
import random

#TÍTULO Y PRESENTACIÓN DEL PROGRAMA
print("\t\b************************\n"
      "\t\b* Juego de Dos o Tres. *\n"
      "\t\b************************")

print("¡Bienvenido al juego de Dos o Tres!. Antes de comenzar con el programa,\n"
      "hemos de advertirle que el programa contiene pausas para hacerlo más comprensible a la lectura.\n"
...
if (reglas == ("Si quiero")) or (reglas == ("si quiero")) or (reglas == ("Si")) or (reglas == ("si")):
    ...
    print("¡Comencemos con el juego!", random.choice(caritasf))
    print(input("[...]"))
...
#PUNTIACIÓN FINAL DEL JUGADOR 1.
print(jug_1,"Su puntuación total fue de:", pun1)

#PUNTIACIÓN FINAL DEL JUGADOR 2.
